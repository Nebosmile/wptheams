...
$custom_attribute = ( isset( $atts['custom_attribute'] ) && $atts['custom_attribute'] ) ? ' ' . $atts['custom_attribute'] . '' : '';
?>
<section<?php echo $custom_id ?> class="fw-main-row<?php echo $custom_class ?> <?php echo $container_class?>" <?php echo $section_style; ?> <?php echo $custom_attribute ?> <?php echo $bg_video_data_attr; ?>>
